...
define("JIAMENG_91JM_PROJECT", "spider-video-bilibili");
define("SOURCE", "bilibili");
...
//            }
            ...
            $params['vid'] = $vid;
            $params['vid_name'] = $vid_name;
            $params['vid_desc'] = $description;
            $params['vid_address'] = json_encode($vid_address);
            $params['vid_pic'] = json_encode($vid_normalpic);
            $params['vid_date'] = $vid_date;
            $params['create_date'] = date("Y-m-d H:i:s");
            $params['vid_author'] = $author;
            $params['vid_tag'] = $tag;
            $params['vid_review'] = $video_review;
            $params['vid_author_pic'] = $authorPic;
            $params['vid_detail_url'] = $url;
